const getRoutes = (mainController, authProvider, router)=>{
    ...
    router.get('/storage/list', authProvider.isAuthenticated, authProvider.getToken, mainController.getStorageList); // get token for this route to call web API
    router.get('/storage/delegationkey', authProvider.isAuthenticated, authProvider.getToken, mainController.getStoragePageDelegationKey); // get token for this route to call web API
